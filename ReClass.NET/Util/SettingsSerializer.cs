	...
	internal sealed class SettingsSerializer
	{
		...
		public static Settings Load()
		{
			...
			try
			{
				...
				if (colors != null)
				{
					XElementSerializer.TryRead(colors, nameof(settings.ControlsBackgroundColor), e => settings.ControlsBackgroundColor = XElementSerializer.ToColor(e));
		...
		public static void Save(Settings settings)
		{
			...
			var document = new XDocument(
				...
				new XElement(
					...
					new XElement(
						XmlColorsElement,
						XElementSerializer.ToXml(nameof(settings.ControlsBackgroundColor), settings.ControlsBackgroundColor),
